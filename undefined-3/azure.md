...
{% hint style="info" %} **참고** DB 서비스 생성은 **Root 권한을 가진 사용자만** 수행할 수 있습니다. {% endhint %}
...
{% hint style="info" %} **참고** OpenSQL 엔진에서 선택한 Extension 설치가 모두 또는 일부 실패한 경우에도 데이터베이스 서비스 자체는 정상적으로 생성되며, 별도의 안내 알림이 함께 발송됩니다. {% endhint %}
