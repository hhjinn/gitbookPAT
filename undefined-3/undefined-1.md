...
2. 재시작할 데이터베이스를 선택한 후, **재시작** 버튼을 클릭합니다. **Overview > 인스턴스 탭** 또는 **Overview > 인스턴스 상세 정보** 메뉴에서도 재시작할 수 있습니다.
3. `{instance alias}`를 재시작하시겠습니까? 모달이 나타나면, **재시작할 인스턴스** 드롭다운에서 재시작할 인스턴스를 선택합니다. 단일 인스턴스 구성인 경우, 해당 드롭다운은 비활성화됩니다.
