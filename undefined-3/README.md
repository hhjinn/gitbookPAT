...
전체 데이터베이스와 하위 인스턴스 목록을 확인합니다. '[전체 상태 요약 정보 확인](#%EC%A0%84%EC%B2%B4-%EC%83%81%ED%83%9C-%EC%9A%94%EC%95%BD-%EC%A0%95%EB%B3%B4-%ED%99%95%EC%9D%B8)'에서 선택한 상태값에 따라 표시되는 데이터베이스 및 인스턴스 목록이 달라집니다.
...
|-----|-----|-----------|---------|-----|-----|
| **이름** | 이름 표시<br>- DB 서비스 이름 클릭 시 '[서비스 메타 정보 조회](/doc/5d7daeb2-e4f4-4409-aa74-dcaf1d65ab46)' 페이지로 이동<br>- 인스턴스 별칭 클릭 시 '[인스턴스 관리](/doc/dF57s45IXBUgU7RX1UvL)' 페이지로 이동 | DB 서비스 이름 | 인스턴스 별칭 | O   | O   |
