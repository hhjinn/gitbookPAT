...
|-----|-----|---------------|---------|-----|-----|
| **이름** | 이름 표시<br>- DB Service 이름 클릭 시 '[서비스 메타 정보 조회](/doc/5d7daeb2-e4f4-4409-aa74-dcaf1d65ab46)' 페이지로 이동<br>- 인스턴스 별칭 클릭 시 '[인스턴스 관리](/doc/dF57s45IXBUgU7RX1UvL)' 페이지로 이동 | DB Service 이름 | 인스턴스 별칭 | O   | O   |
