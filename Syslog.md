...
{% hint style="info" %} **참고**
Tibero의 DB 탭만 사용할 수 있습니다. {% endhint %}
...
{% hint style="info" %} **참고**
DB Syslog는 최근 7일 이내의 데이터만 조회할 수 있습니다. 7일을 초과한 로그는 표시되지 않습니다. {% endhint %}

{% hint style="warning" %} **주의**
DB Service가 `Terminating` 상태이면 Syslog를 조회할 수 없습니다. 화면 상단에 안내 배너가 표시됩니다. {% endhint %}
...
{% hint style="info" %} **참고**
컴포넌트 로그 조회는 **Azure 환경의 OpenSQL**에서만 사용할 수 있습니다. AWS 환경 및 Tibero에서는 \[Component\] 탭이 표시되지 않습니다. {% endhint %}
...
{% hint style="info" %} **참고**
컴포넌트 로그 다운로드는 **Azure 환경의 OpenSQL**에서만 사용할 수 있습니다. {% endhint %}
