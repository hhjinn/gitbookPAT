...
{% hint style="info" %} **참고**
Tibero의 Single은 2vCPU, Memory 8GiB 이상의 인스턴스 유형을 권장합니다.   Tibero의 TAC는 4vCPU 이상의 인스턴스 유형만 사용 가능하며, 8vCPU 이상을 권장합니다. {% endhint %}
...
{% hint style="info" %} **참고**
Tibero TAC 토폴로지의 볼륨크기는 최소 200GiB 이상의이어야 합니다. {% endhint %}
