...
- **OpenBackup**: DB Service당 로그 파일이 1개 생성됩니다.
- **OpenProxy**: OpenProxy가 설치된 인스턴스마다 로그 파일이 1개 생성되며, 미설치 인스턴스의 파일은 목록에 표시되지 않습니다.
- **OpenHA**: 인스턴스마다 로그 파일이 1개 생성됩니다.
{% endhint %}
...
다운로드가 완료되면 결과를 토스트 메시지로 안내합니다.

- **성공**: "Syslog 파일이 다운로드되었습니다." 표시
- **실패**: "Syslog 파일 다운로드에 실패했습니다. 다시 시도해 주세요." 표시
