...
6. 필요한 경우 ⚙️ 아이콘을 클릭하여 자동 새로고침을 설정합니다.
7. 데이터를 즉시 갱신하려면 🔃 아이콘을 클릭합니다.
...
| View | 설명  |
|------|-----|
| Instance View (기본값) | <p>- 선택한 Database의 지표를 합산 또는 평균하여 Instance 단위로 표시</p><p>- DB Select 트리는 2단계로 표시</p> |
| Database View | <p>- 선택한 Database별로 지표를 분리하여 표시</p><p>- DB Select 트리는 3단계로 전환</p> |
