...
<table data-full-width="true"><thead><tr><th>항목</th><th>설명</th><th>비고</th></tr></thead><tbody><tr><td>OwlDB Root User Name</td><td>OwlDB에 로그인하기 위한 기본 관리자 계정의 ID</td><td><ul><li>Default : admin</li><li>설정 이후 변경 불가</li></ul></td></tr></tbody></table>
