...
| `OPENSQL_HOME` |     | <ul><li><a href="db-1.md#h-2-파일-배치">2. 파일 배치</a>단계에서 이미 환경 변수가 설정되어 있으면 미입력</li><li>환경 변수가 없으면 위에서 사용한<code>OPENSQL_HOME</code> 입력</li></ul> |
...
| `BARMAN_CONF_DIR` | <p>barman host의 conf 디렉토리 경로<br>e.g.)<code>/etc/barman.d/</code></p> |       |
