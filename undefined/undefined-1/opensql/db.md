...
1. agent 바이너리를 압축 해제 합니다. tar -zxvf owlagent_dist_latest.tar.gz owlagent_dist_latest.tar.gz └── owlagent_dist/ ├── config.json.description ├── manifest ├── owlagent ├── owlagent.env ├── owlagent_start.sh └── owlagent_stop.sh
