...
| OPENSQL\_HOME       |                    | <ul><li>이미 설정 시 입력 불필요</li><li>미설정 시 위에서 사용한 OPENSQL_HOME 입력</li></ul> |
...
| 0 이외 | <p>아래 두 경우가 구분되지 않아 b 추가 수행 필요</p><ul><li>다른 유닛명으로 기동된 경우</li><li>systemd 미등록인 경우</li></ul> |
