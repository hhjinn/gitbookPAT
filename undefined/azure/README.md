...
| 유형  | 적합 워크로드 | Disk Size (GiB) | Disk IOPS (IOPS) |
|-----|-----------|-----------------|-----------------|
| Ultra Disk | Azure 가상 머신(VM)용 스토리지 옵션<br>- SAP HANA 등 데이터 집약적 워크로드<br>- 트랜잭션 다수 워크로드 | 100 \~ 65,536 | 3,000 \~ 400,000 |
| Premium SSD v2 | 가상 머신·컨테이너용 고성능 스토리지 옵션<br>- 빅데이터 분석<br>- 게임 실행 | 100 \~ 65,536 | 3,000 \~ 80,000 |
