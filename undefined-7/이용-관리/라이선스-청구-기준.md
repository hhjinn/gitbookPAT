...
{% hint style="info" %} **참고** 인스턴스, 스토리지, 네트워크 등 인프라 리소스 요금은 이 기준과 무관하게 각 CSP의 과금 정책에 따라 별도로 발생합니다. {% endhint %}
...
{% hint style="info" %} **참고** 일시적으로 DB 서비스를 사용하지 않을 예정이라면 **중지**를 권장합니다.
