...
<table><thead><tr><th>항목</th><th>기준</th></tr></thead><tbody><tr><td>최소 과금 단위</td><td>1분</td></tr><tr><td>초 단위 처리</td><td>분 단위로 올림</td></tr><tr><td>요금 표시</td><td><ul><li>달러($) 표시</li><li>소수점 둘째 자리 반올림</li></ul></td></tr></tbody></table>
...
* 스토리지 요금을 포함한 모든 요금 발생을 중단하려면 DB 서비스를 삭제해야 합니다.
{% endhint %}

{% hint style="warning" %}
**주의**

DB 서비스를 삭제하면 인스턴스, 볼륨, 백업 등 모든 리소스와 데이터가 영구적으로 삭제되며 복구할 수 없습니다.
{% endhint %}
