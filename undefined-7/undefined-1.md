...
When you enter the **Account Management** menu, you can view all accounts registered in OwlDB. You can filter by account status or search by ID, name, or email.
...
To modify the account, click **Edit** on the details page.
...
2. Click **Delete**.
3. In the confirmation modal, click **Delete** to immediately block access for the corresponding account.
