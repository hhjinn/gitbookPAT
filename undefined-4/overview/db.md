...
| 항목                 | Tibero                                                              | OpenSQL                                                                                   |
| ------------------ | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Basic Info         | <ul><li>메이저 버전</li><li>마이너 버전</li><li>패치셋 버전</li></ul>              | <ul><li>OpenSQL 버전(예: 3.0)</li><li>PostgreSQL 버전(예: 17.5)</li></ul>                       |
| 시스템 및 컴파일 정보       | 바이너리 OS 정보 등 리스트 표시                                                 | 바이너리 OS 정보 등 리스트 표시                                                                       |
| 패치 정보 / Extensions | <ul><li>적용된 패치 현황 리스트 표시</li><li>없으면 "적용된 패치가 없습니다" 문구 표시</li></ul> | <ul><li>현재 설치된 Extension 목록 리스트 표시</li><li>운영 중 DDL로 추가한 Extension도 조회 시점 기준 반영</li></ul> |
...
| ----- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | --- |
| ID    | <ul><li>전환 이벤트를 고유하게 식별하는 번호</li><li>형식: {이벤트유형-랜덤 문자열 16바이트}</li><li>이벤트 유형: FO / SO / FB</li></ul> | <ul><li>FO-3f9a7c1e2d8b45f0</li><li>SO-b17e4a93d2c68f5e</li><li>FB-7a2d9e14c6b83f05</li></ul>                                                                                                                                                                                                                                                                              | O   | X   |
| 시작 시간 | 전환 이벤트가 발생한 시각                                                                                       | yyyy.mm.dd HH:mm:ss                                                                                                                                                                                                                                                                                                                                                        | O   | O   |
| 완료 시간 | 전환 이벤트가 완료된 시각                                                                                       | yyyy.mm.dd HH:mm:ss                                                                                                                                                                                                                                                                                                                                                        | X   | X   |
| 유형    | 전환 이벤트 유형                                                                                            | <ul><li>Failover</li><li>Switchover</li><li>Failback</li></ul>                                                                                                                                                                                                                                                                                                             | O   | O   |
| 수행 대상 | 해당 이벤트를 수행한 대상                                                                                       | <ul><li>Switchover: {사용자 아이디}</li><li>Failover: {사용자 아이디} / system(Auto Failover)</li><li>Failback: {사용자 아이디}</li></ul>                                                                                                                                                                                                                                                    | O   | X   |
| 결과    | 해당 이벤트 상태 표시                                                                                         | <ul><li>성공</li><li>실패</li></ul>                                                                                                                                                                                                                                                                                                                                            | O   | X   |
| 원인/비고 | 해당 이벤트가 발생한 원인, 사용자가 입력한 값 또는 실패 사유 표시                                                               | <ul><li>역할 전환 시 사용자가 선택적으로 입력한 값(최대 200자, 미입력 시 빈칸)</li><li>Auto Failover의 트리거 조건</li><li>Failback 실패 시: Standby/Replica Reboot Failed 또는 Switchover Failed</li><li>Failover 실패 시: Standby/Replica Promotion Failed</li><li>Failover 성공 후 후처리 실패 시: Cluster Normalization Failed(Primary scale out failed / New Standby/Replica creation failed, 복수 실패 시 콤마로 표시)</li></ul> | O   | X   |
{% endtab %}
{% endtabs %}
