OwlDB에서 운영 중인 데이터베이스 상태를 모니터링하고, 필요에 따라 데이터베이스를 수정, 중지, 시작, 삭제, 역할전환, 라이선스 갱신 및 스펙변경을 수행할 수 있습니다. 버튼을 통해 빠르게 원하는 작업을 수행할 수 있으며, 데이터베이스 성능을 최적화하기 위해 다양한 설정을 조절할 수 있습니다. 인스턴스 상태가 `Running`이 아닌 경우, 일부 정보가 누락될 수 있습니다.
...
4. 데이터베이스 운영 상태는 **전체 상태 요약 정보** 페이지를 참고하시기 바랍니다.
