...
* **재시작** 버튼으로 인스턴스를 재시작할 수 있습니다. 자세한 내용은 "[인스턴스 재시작](#undefined-2)"을 참고하시기 바랍니다.
  * **인스턴스 선택 후**: ☑️ 아이콘으로 1개 이상의 인스턴스를 선택한 뒤 **재시작** 버튼을 클릭합니다.
  * **선택 없이**: **재시작** 버튼을 바로 클릭하면 열리는 모달에서 재시작할 인스턴스와 재시작 옵션을 선택합니다.
