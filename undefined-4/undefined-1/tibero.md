...
1. '[테이블스페이스 조회](#%ED%85%8C%EC%9D%B4%EB%B8%94%EC%8A%A4%ED%8E%98%EC%9D%B4%EC%8A%A4-%EC%A1%B0%ED%9A%8C)'를 참고하여 데이터 파일을 조회할 데이터베이스를 선택합니다.
...
1. '[데이터 파일 조회](#%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%8C%8C%EC%9D%BC-%EC%A1%B0%ED%9A%8C)'를 참고하여 데이터 파일을 생성할 테이블스페이스를 선택합니다.
2. **생성** 버튼을 클릭합니다.
...
1. '[데이터 파일 조회](#%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%8C%8C%EC%9D%BC-%EC%A1%B0%ED%9A%8C)'를 참고하여 데이터 파일을 수정할 테이블스페이스를 선택합니다.
2. **수정** 버튼을 클릭합니다.
...
1. '[데이터 파일 조회](#%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%8C%8C%EC%9D%BC-%EC%A1%B0%ED%9A%8C)'를 참고하여 데이터 파일을 삭제할 테이블스페이스를 선택합니다.
2. **삭제** 버튼을 클릭합니다.
