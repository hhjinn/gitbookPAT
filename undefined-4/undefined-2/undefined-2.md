...
{% hint style="warning" %} **주의** 자동 백업을 켜면 설정한 주기와 보존 기간에 따라 저장 용량이 늘어나며, 별도 요금이 발생합니다. {% endhint %}
...
{% hint style="warning" %} **주의** 자동 백업을 켜짐으로 설정하면 저장 주기와 보존 기간에 따라 저장 용량이 늘어나며, 별도 요금이 발생합니다. {% endhint %}
