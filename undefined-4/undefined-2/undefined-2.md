...
| Full Backup 주기        | Full Backup 실행 주기        | <ul><li>시간마다: 1~23</li><li>일마다: 1~7</li></ul>               |
| 보존 기간                 | Full Backup 이미지 보존 기간    | <ul><li>시간마다: 1~23</li><li>일마다: 1~35</li><li>영구보관</li></ul> |
| 시작 시간                 | Full Backup 시작 일시        | 현재보다 과거 일시 선택 불가                                            |
| Incremental Backup    | Incremental Backup 사용 여부 | 기본값: 꺼짐                                                     |
| Incremental Backup 주기 | Incremental Backup 실행 주기 | <ul><li>시간마다: 1~23</li><li>일마다: 1~6</li></ul>               |
