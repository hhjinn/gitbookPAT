...
{% hint style="warning" %}
**주의** 자동 백업을 켜면 설정한 주기와 보존 기간에 따라 저장 용량이 늘어나며, 별도 요금이 발생합니다.
{% endhint %}
...
| 자동 백업 주기 | 백업을 실행할 주기        | <p>* 시간마다: 1~23<br>* 일마다: 1~7</p>  |
| 보존 기간    | 백업 이미지를 보존할 기간    | <p>* 시간마다: 1~23<br>* 일마다: 1~35</p> |
| 시작 시간    | 자동 백업이 시작될 날짜와 시간 | 현재보다 과거 일시는 선택 불가                  |

{% hint style="warning" %}
**주의** 자동 백업을 켜짐으로 설정하면 저장 주기와 보존 기간에 따라 저장 용량이 늘어나며, 별도 요금이 발생합니다.
{% endhint %}
