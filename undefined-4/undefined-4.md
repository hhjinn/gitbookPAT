...
현재 CDB 이관만 지원하며, 추후 PDB 이관 지원 예정입니다.
{% endhint %}
...
| Oracle                | Tibero                | 비고                                                                                                                                                                                                   |
| --------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Constraint            | Constraint            | <p>Primary Key, Foreign Key, Check, Ref Constraint에 대해 이관을 지원함</p><ul><li>Primary Key index/constraint는 모두 constraint로 처리함</li><li>Check constraint의 표현식은 Oracle의 DD에 저장된 문장을 이용해 DDL을 생성함</li></ul> |
| Index                 | Index                 | <ul><li>R-TREE 미지원</li><li>Domain Index 미지원</li></ul>                                                                                                                                                |
...
| Sequence              | Sequence              | -                                                                                                                                                                                                    |
| Synonym               | Synonym               | -                                                                                                                                                                                                    |
| Table                 | Table                 | <ul><li>Nested Table 미지원</li><li>XML Table 미지원</li></ul>                                                                                                                                             |
...
| ------------------------------ | --------------------------------- |
| blob                           | BLOB                              |
| binary\_float                  | BINARY\_FLOAT                     |
| binary\_double                 | BINARY\_DOUBLE                    |
| character                      | CHAR                              |
| clob                           | CLOB                              |
| date                           | DATE                              |
